            ...
            <table class="table table-bordered table-striped">
                ...
                <?php foreach ($addressbook as $row3): ?>
                            ...
                            <td><?php echo $row3->studentNumber; ?></td>
                                ...
                                <td> <a href="<?php echo site_url('Docs/Download');?>/<?php echo $row3->id;?>" class="btn btn-primary btn-sm">Download</a> | <a href="<?php echo site_url('Docs/delete');?>/<?php echo $row3->id;?>/<?php echo $row3->studentNumber; ?>" class="btn btn-primary btn-sm">Delete</a>
                                </td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
