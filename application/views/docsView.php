        ...
        <h1>PDF Docs </h1>
            ...
            <label for="exampleInputEmail1">Section:</label>
                    ...
                    <?php foreach($section as $row2) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Docs/sectionPick');?>/<?php echo $row->batchID;?>/<?php echo $row2->sectionID;?>"><?php echo $row2->section;?></a></li>
                        <?php } ?>
             ...
             <div class="btn-group">
                   ...
                   Batch
                    ...
                    <?php foreach($batch as $row1) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Docs/batchPick');?>/<?php echo $row1->batchID;?>/<?php echo $row->sectionID;?>"><?php echo $row1->batchName;?></a></li>
                        <?php } ?>
        ...
        <div class="col-2">
            ...
            <table class="table table-bordered table-striped">
                <thead  class="thead-dark">
                    ...
                    <th scope="col">Eligible to Render Hours</th>
                    <th scope="col">Approve Documents</th>
                ...
                <?php foreach ($addressbook as $row3): ?>
                            ...
                            <td><?php echo $row3->studentNumber; ?></td>
                                <td><?php echo $row3->firstName; ?> &nbsp; <?php echo $row3->middleName; ?> &nbsp; <?php echo $row3->lastName; ?> &nbsp; <?php echo $row3->suffix; ?> </td>
                             
                                  <?php if (  $row3->isAbleToRender === '1' ) : ?>
                                     <td>Yes</td>
             <?php else : ?>
                     <td>No</td>
             <?php endif; ?>
                                <td><a href="<?php echo site_url('Docs/approve');?>/<?php echo $row3->studentNumber;?>" class="btn btn-primary btn-sm">Yes</a> | <a href="<?php echo site_url('Docs/disapprove');?>/<?php echo $row3->studentNumber;?>" class="btn btn-primary btn-sm">No</a></td>

                                <td> <a href="<?php echo site_url('Docs/weeklyReport2');?>/<?php echo $row3->studentNumber;?>" class="btn btn-primary btn-sm">PDF Files</a>
                                </td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
