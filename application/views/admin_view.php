                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="text" readonly name="name" value="<?php echo $row->firstName; ?> <?php echo $row->lastName; ?>" class="form-control" placeholder="" aria-label="Name" aria-describedby="basic-addon1">
                            </div>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="text"  readonly value="<?php echo $row->email; ?>" class="form-control" placeholder="" aria-label="Email" aria-describedby="basic-addon1">
                            </div>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-md-4 col-md-offset-4">
                            ...
                            <div class="input-group mb-3">
                                    ...
                                    <input type="text" readonly  value="<?php echo $row->username; ?>"  class="form-control" placeholder="" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
