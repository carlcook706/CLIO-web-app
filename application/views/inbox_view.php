...
<?php else : ?>
    ...
    <div class="container">
        ...
        <br>
            ...
            <div class="col-10">
                <a data-toggle="collapse" href="#<?= $row->rciID?>" role="button" aria-expanded="false" aria-controls="collapseExample">
                <p class="text-left text-white bg-secondary"><?php echo $row->supfirstName; ?> <?php echo $row->suplastName; ?> <?php echo $row->suffix; ?> </p>
                </a>
                <div class="collapse" id="<?= $row->rciID?>">
                        ...
                        <div class="card">
                                ...
                                <p class="card-text"><?php echo $row->userTypeName; ?></p>
                                <p class="card-text">Supervisor ID: <?php echo $row->id;?> </p>
                                <p class="card-text">Contact No.: <?php echo $row->contactID;?>  </p>
