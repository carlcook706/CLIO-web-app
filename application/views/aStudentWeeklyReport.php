            ...
            <table class="table table-bordered table-striped">
                ...
                <?php foreach ($addressbook as $row3): ?>
                            ...
                            <td><?php echo $row3->studentNumber; ?></td>
                                ...
                                <td><?php echo $row3->timeDiff; ?></td>
                                <td><?php echo $row3->tasks; ?></td>
                                <td><?php echo $row3->lesson; ?></td>
                                <td><?php echo $row3->totalHours; ?></td>
                                 <td><?php echo $start->date; ?></td>
                                <td><?php echo $row3->totalHoursToRender-$row3->totalHours; ?></td>

                                <td> <a href="<?php echo site_url('Ojt/comment');?>/<?php echo $row3->weeklyReportID;?>/<?php echo $row3->studentNumber;?>" class="btn btn-primary btn-sm">Comment</a>
                                </td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
