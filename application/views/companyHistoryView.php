            ...
            <table class="table table-bordered table-striped">
                ...
                <?php foreach ($addressbook as $row3): ?>
                            <tr>
                                ...
                                <td><?php echo $row3->postCompanyName; ?></td>
                                <td><?php echo $row3->postStreet; ?> &nbsp; <?php echo $row3->postBaranggay; ?> &nbsp; <?php echo $row3->postCity; ?> &nbsp; <?php echo $row3->postProvince; ?></td>
                                <td><?php echo $row3->postSupFirstName; ?> &nbsp; <?php echo $row3->postSupLastName; ?></td>
                                <td><?php echo $row3->postContactNo; ?></td>
                                <td><?php echo $row3->postEmail; ?></td>
