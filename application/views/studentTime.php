        ...
        <h1> Student's OJT Info</h1>
            ...
            <label for="exampleInputEmail1">Section:</label>
                    ...
                    <?php foreach($section as $row2) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Ojt/timeRecordSectionPick');?>/<?php echo $row->batchID;?>/<?php echo $row2->sectionID;?>"><?php echo $row2->section;?></a></li>
                        <?php } ?>
             ...
             <div class="btn-group">
               ...
               Batch
                    ...
                    <?php foreach($batch as $row1) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Ojt/timeRecordBatchPick');?>/<?php echo $row1->batchID;?>/<?php echo $row->sectionID;?>"><?php echo $row1->batchName;?></a></li>
                        <?php } ?>
        ...
        <div class="col-2">
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    ...
                    <th scope="col">Total Hours to Render</th>
                ...
                <?php foreach ($addressbook as $roww): ?>
                            <tr>
                            <td><?php echo $roww->studentNumber; ?></td>
                                <td><?php echo $roww->firstName; ?> &nbsp; <?php echo $roww->lastName; ?></td>
                               
                                <td><?php echo $roww->totalHours; ?></td>
                                <td><?php echo $roww->totalHoursToRender-$roww->totalHours; ?></td>
                                <td><?php echo $roww->totalHoursToRender; ?></td>
                                <td> <a href="<?php echo site_url('Ojt/getStudentTime2');?>/<?php echo $roww->studentNumber;?>/<?php echo $row->sectionID;?>" class="btn btn-primary btn-sm">Time Record</a> | <a href="<?php echo site_url('Ojt/getTotalHoursToRender');?>/<?php echo $roww->studentNumber;?>" class="btn btn-secondary btn-sm"> Hours To Render</a>
                                </td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
