            ...
            <?php endif; ?>
                ...
                <?php foreach ($addressbook as $row): ?>
                            <tr>
                                ...
                                <td> <a href="<?php echo site_url('Master_list/edit');?>/<?php echo $row->studentNumber;?>" class="btn btn-outline-secondary btn-sm">Edit</a>  | 
                   <a class="btn btn-primary btn-sm" href="<?php echo site_url('Master_list/delete');?>/<?php echo $row->studentNumber;?>/<?php echo $row->username;?>">Delete</a> </td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
        </table></div>
