     ...
     <div class="row">
        ...
        <h1> Student's OJT Info</h1>
            ...
            <label for="exampleInputEmail1">Section:</label>
                    ...
                    <?php foreach($section as $row2) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Ojt/studentSectionPick');?>/<?php echo $row->batchID;?>/<?php echo $row2->sectionID;?>"><?php echo $row2->section;?></a></li>
                        <?php } ?>
             ...
             <div class="btn-group">
                  ...
                  Batch
                    ...
                    <?php foreach($batch as $row1) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Ojt/studentBatchPick');?>/<?php echo $row1->batchID;?>/<?php echo $row->sectionID;?>"><?php echo $row1->batchName;?></a></li>
                        <?php } ?>
        ...
        <div class="row">
          ...
          <div class="row">
            ...
            <form method="post" action="<?php echo site_url('Ojt/search')?>/<?php echo $row->batchID;?>">
            <div class="input-group mb-3">
        ...
        <div class="col-2">
            ...
            <table class="table table-bordered table-striped">
                <thead  class="thead-dark">
                  ...
                  <th scope="col" >OJT Schedule</th>
                    <th scope="col">OJT Supervisor</th>  
                    <th scope="col">Contact No.</th>  
                    <th scope="col">Email</th>
                     <th scope="col">Company History</th>
                    </tr>
                </thead>
                <tbody>
                <?php foreach ($addressbook as $row3): ?>
                            ...
                            <td><?php echo $row3->studentNumber; ?></td>
                                ...
                                <td><?php echo $row3->street; ?> &nbsp; <?php echo $row3->baranggay; ?> &nbsp; <?php echo $row3->city; ?> &nbsp; <?php echo $row3->province; ?></td>
                                 <td><?php echo $row3->link; ?> </td> 
                                <td><?php echo $row3->directions; ?> </td> 
                                <td><?php echo $row3->timeAndDayOfWork; ?> </td> 
                                <td><?php echo $row3->supfirstName; ?> &nbsp; <?php echo $row3->suplastName; ?></td>
                                <td><?php echo $row3->contactID; ?></td>
                                <td><?php echo $row3->email; ?></td>
                                 <td> <a href="<?php echo site_url('Ojt/viewCompanyHistory');?>/<?php echo $row3->studentNumber;?>/<?php echo $row->sectionID;?>" class="btn btn-primary btn-sm">View </a>  
                    </td>
                            </tr>
                <?php endforeach; ?>
                </tbody>
