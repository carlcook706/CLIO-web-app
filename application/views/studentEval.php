        ...
        <h1> Student's OJT Info</h1>
            ...
            <label for="exampleInputEmail1">Section:</label>
                    ...
                    <?php foreach($section as $row2) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Ojt/evaluationSectionPick');?>/<?php echo $row->batchID;?>/<?php echo $row2->sectionID;?>"><?php echo $row2->section;?></a></li>
                        <?php } ?>
             ...
             <div class="btn-group">
                  ...
                  Batch
                    ...
                    <?php foreach($batch as $row1) {?>
                        <li><a class="dropdown-item" href="<?php echo site_url('Ojt/evaluationBatchPick');?>/<?php echo $row1->batchID;?>/<?php echo $row->sectionID;?>"><?php echo $row1->batchName;?></a></li>
                        <?php } ?>
        ...
        <div class="col-2">
            ...
            <table class="table table-striped table-bordered">
                <thead>
                    ...
                    <th scope="col">OJT Evaluation Date</th>
                ...
                <?php foreach ($addressbook as $row): ?>
                            ...
                            <td><?php echo $row->studentNumber; ?></td>
                                ...
                                <td><?php echo $row->totalHoursToRender-$row->totalHours; ?></td>
                                 <td><?php echo $row->evaluationDate; ?></td>
                                <td><?php echo $row->supfirstName; ?> <?php echo $row->suplastName; ?></td>
                                <td><?php echo $row->remarks; ?></td>
                                <td><a href="<?php echo site_url('Ojt/download');?>/<?php echo $row->studentNumber;?>" class="btn btn-success btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
  <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
</svg></a></td> <td><a href="<?php echo site_url('Ojt/downloadCertificate');?>/<?php echo $row->studentNumber;?>" class="btn btn-success btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-download" viewBox="0 0 16 16">
  <path d="M.5 9.9a.5.5 0 0 1 .5.5v2.5a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1v-2.5a.5.5 0 0 1 1 0v2.5a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2v-2.5a.5.5 0 0 1 .5-.5z"/>
  <path d="M7.646 11.854a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V1.5a.5.5 0 0 0-1 0v8.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3z"/>
</svg></a></td>
